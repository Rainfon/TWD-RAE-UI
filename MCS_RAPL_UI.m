function MCS_RAPL_UI
% MCS_RAPL_UI  Interactive TWD-RAPL multicriteria sorting demo.
%
% Data format:
...
%   4. Let TWD-RAPL recommend a high-risk alternative to query.
%   5. Submit the decision maker's class feedback and update the model.
    ...
    fig = uifigure('Name', 'TWD-RAPL Interactive Multicriteria Sorting System', ...
...
function out = translateEN(key)
    switch key
        case "appName"
            out = 'TWD-RAPL Interactive Multiple Criteria Sorting System';
        case "title"
            out = 'TWD-RAPL Interactive Multiple Criteria Sorting System';
        case "subtitle"
            out = '';
